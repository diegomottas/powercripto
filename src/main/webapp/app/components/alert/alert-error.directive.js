(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('powercriptoApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-powercriptoApp-error');
                var entityKey = httpResponse.headers('X-powercriptoApp-params');
                if (errorHeader) {
