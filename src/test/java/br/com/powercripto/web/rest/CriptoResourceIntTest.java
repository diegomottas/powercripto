...
public class CriptoResourceIntTest {
    ...
    private static final Long DEFAULT_QUANTIDADE_REGISTROS = 1L;
    private static final Long UPDATED_QUANTIDADE_REGISTROS = 2L;
    ...
    public void initTest() {
        ...
        cripto.setQuantidadeRegistros(DEFAULT_QUANTIDADE_REGISTROS);
        cripto.setHash(DEFAULT_HASH);
    }
    ...
    public void createCripto() throws Exception {
        ...
        assertThat(testCripto.getQuantidadeRegistros()).isEqualTo(DEFAULT_QUANTIDADE_REGISTROS);
        assertThat(testCripto.getHash()).isEqualTo(DEFAULT_HASH);
    }
    ...
    public void getAllCriptos() throws Exception {
        ...
        restCriptoMockMvc.perform(get("/api/criptos?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].quantidadeRegistros").value(hasItem(DEFAULT_QUANTIDADE_REGISTROS.intValue())))
    ...
    public void getCripto() throws Exception {
        ...
        restCriptoMockMvc.perform(get("/api/criptos/{id}", cripto.getId()))
            ...
            .andExpect(jsonPath("$.quantidadeRegistros").value(DEFAULT_QUANTIDADE_REGISTROS.intValue()))
    ...
    public void updateCripto() throws Exception {
        ...
        updatedCripto.setQuantidadeRegistros(UPDATED_QUANTIDADE_REGISTROS);
        updatedCripto.setHash(UPDATED_HASH);
        ...
        assertThat(testCripto.getQuantidadeRegistros()).isEqualTo(UPDATED_QUANTIDADE_REGISTROS);
        assertThat(testCripto.getHash()).isEqualTo(UPDATED_HASH);
    }
